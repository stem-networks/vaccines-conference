            ...
            <div className='past-conference-page'>
                <section className="about-conf-section">
                    ...
                    <div className="overview-content-block wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                        ...
                        <p><Link href="/" title={general_info?.clname}>{general_info?.clname} ({general_info?.csname}-2025)</Link> was successfully organized on <span>October 08-10, 2025, in Switzerland,</span> bringing together global leaders, researchers, academicians, and industry experts for three days of knowledge-sharing and collaboration.</p>
                    ...
                    <div className="auto-container">
                        <div className="content1 wow fadeInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                            ...
                            <ul>
                                ...
                                <li>
                                    <span>Distinguished Speakers:</span> Our keynote speakers delivered insightful presentations on cutting-edge topics in Vaccines, Virology, Immunology and Infectious Diseases Conference.
                                </li>
                                <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    Exchange of new ideas and research breakthroughs in <Link href="/" title={general_info?.clname}>Pharma, Pharmaceutics, Biotechnology, Vaccines, Virology, Immunology, Infectious Diseases and HIV Conference.</Link>
                                </li>
                                <li>
