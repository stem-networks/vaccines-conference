            ...
            <section className="hero-conference-section">
                ...
                <div className="hero-conference-content">
                    <div className="auto-container">
                        ...
                        <h3 className="banner-heading-tagline wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">{tag_line || ""}</h3>
                        <button className="download-brochure-btn wow zoomIn" data-wow-delay="600ms" data-wow-duration="1000ms" title={`${general?.clogotext}_Brochure`}
